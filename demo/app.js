const stages = [
  ...
  {
    id: "ideas", short: "文献与选题", label: "Literature & Ideas", path: "ideas",
    title: "检索不是装饰，拥挤方向不会硬推",
    description: "每个 idea 都必须面对最近工作与最强 reviewer objection。",
    summary: ["多角度文献检索", "最近工作核对", "新颖性硬门槛", "研究者选择"],
    compare: ["通常用排序快速呈现候选方向", "研究者再从候选中判断新颖性与价值", "Research Buddy 把新颖性设为推荐前的独立硬门槛"],
    render: () => `
      <div class="stage-head"><div><p class="eyebrow">STEP 02 · RESEARCHLIT + IDEAGEN</p><h3>先让 idea 经得住最近工作</h3><p>检索到的证据直接决定候选能否进入推荐榜，而不是只生成一段“看起来新颖”的描述。</p></div><span class="status-pill">NOVELTY GATE</span></div>
      <div class="workspace-grid">
        <div class="panel"><div class="panel-head"><strong>Literature landscape</strong><span>verified sources</span></div><div class="landscape"><div class="paper-row"><span>25</span><div><strong>Adaptive stability</strong><small>confidence routing · early exit</small></div><b>CROWDED</b></div><div class="paper-row"><span>18</span><div><strong>Falsification probes</strong><small>counterarguments · controls</small></div><b>EMERGING</b></div><div class="paper-row"><span>11</span><div><strong>Traceable debate</strong><small>evidence accounting</small></div><b>OPEN GAP</b></div></div></div>
  ...
  },
  {
    ...
    render: () => `
      <div class="stage-head"><div><p class="eyebrow">STEP 03 · EXPPLAN</p><h3>从证据空位拆出多层 Goals</h3><p>每个 Goal 都去填写明确的表格 cell 或 figure panel：进度可见、证据不漏、失败可停。</p></div><span class="status-pill">APPROVAL REQUIRED</span></div>
      <div class="workspace-grid wide-left">
  ...
  },
  {
    ...
    render: state => `
      <div class="stage-head"><div><p class="eyebrow">STEP 04 · RUNPLAN + /GOAL</p><h3>清楚知道下一项要做什么</h3><p>计划是人能读懂的网页；详细 acquisition contract 留在机器可读状态中。</p></div><span class="status-pill">${state.goalDone ? "GOAL COMPLETE" : "1 GOAL UNLOCKED"}</span></div>
      <div class="workspace-grid wide-left">
