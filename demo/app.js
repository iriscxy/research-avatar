...
const stages = [
  {
    ...
    render: () => `
      ...
      <div class="workspace-grid wide-left">
        ...
        <div class="panel"><div class="panel-head"><strong>paper/WRITING_STYLE.md</strong><span>15 full papers</span></div><div class="paper-outline"><div class="outline-section"><strong>Abstract</strong><span>problem → gap → method → evidence</span></div><div class="outline-section"><strong>Claims</strong><span>谨慎措辞，结果先于结论</span></div><div class="outline-section"><strong>Structure</strong><span>会议匹配的章节与图表习惯</span></div><div class="outline-section"><strong>Usage</strong><span>后续 Idea、实验与写作共同读取</span></div></div></div>
      </div>`
  },
  {
    ...
    render: () => `
      ...
      <div class="workspace-grid">
        ...
        <div class="panel"><div class="panel-head"><strong>Survey synthesis</strong><span>taxonomy → gaps</span></div><div class="paper-outline"><div class="outline-section"><strong>Taxonomy</strong><span>persona / narrative / register / encoding</span></div><div class="outline-section"><strong>Collision</strong><span>最近工作直接占据哪些 claim</span></div><div class="outline-section"><strong>Debate</strong><span>纯 style 还是语义与语用变化</span></div><div class="outline-section"><strong>Gap</strong><span>缺少跨模型的因果机制证据</span></div></div></div>
      </div>`
  },
  {
    ...
    render: state => `
      ...
      <div class="workspace-grid">
        ...
        <div class="panel"><div class="panel-head"><strong>Qualification gates</strong><span>general-purpose</span></div><div class="paper-outline"><div class="outline-section"><strong>Novel</strong><span>最近工作不能直接吸收核心贡献</span></div><div class="outline-section"><strong>Necessary</strong><span>题目设定对中心 claim 确有必要</span></div><div class="outline-section"><strong>Focused</strong><span>存在一个不可拆散的核心机制</span></div><div class="outline-section"><strong>Falsifiable</strong><span>最强反方能指出停止或收窄条件</span></div></div><div class="approval-state ${state.ideaConfirmed ? "approved" : ""}">${state.ideaConfirmed ? "人工选择已确认；下一步可生成实验设计。" : "Skill 只推荐，不替研究者做最终选择。"}</div></div>
      </div>`
  },
  {
  ...
  },
  {
    ...
    render: state => `
      ...
      ${state.paperView === "tables" ? `<div class="workspace-grid wide-left"><div class="panel"><div class="panel-head"><strong>Table sequence</strong><span>只读取已核验结果</span></div><div class="goal-list"><div class="goal current"><span class="goal-icon">→</span><div><strong>T1 · Main results</strong><small>来源：RESULTS_LEDGER.csv</small></div><b>READY</b></div><div class="goal"><span class="goal-icon">○</span><div><strong>T2 · Ablation</strong><small>等待全部 cells verified</small></div><b>BLOCKED</b></div></div></div><div class="panel"><div class="panel-head"><strong>T1 LaTeX preview</strong><span>可编辑</span></div><table class="result-shell"><thead><tr><th>Method</th><th>ASR ↑</th></tr></thead><tbody><tr><td>PAIR</td><td>31.8</td></tr><tr><td>Ours</td><td class="verified-mark">42.1</td></tr></tbody></table><div class="source-list"><span><b>Provenance</b> R1 → raw output → command</span><span><b>Placement</b> Section 5 · after E2</span></div><button type="button" class="confirm-action" data-action="approve-table">${state.tableApproved ? "✓ Table T1 已批准并插入" : "批准 Table T1 →"}</button></div></div>` : ""}`
  }
];
